...
<head>
<meta charset="UTF-8">
<title>Gold Web Service AEU</title>
		...
		function addApiKeyAuthorization() {
			...
			if (key && key.trim() != "") {
				var apiKeyAuth = new SwaggerClient.ApiKeyAuthorization(
						"Authorization", "Basic c2V5aGE6Z3JvdXAyMTIzNDU2",
						"header");
	...
	<div id='header'>
		<div class="swagger-ui-wrap">
			...
			<form id='api_selector'>
				...
				<div class='input'>
					<input placeholder="api_key" value="Basic 2017_As!23456"
