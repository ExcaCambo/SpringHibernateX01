...
@MapperScan("com.knongdai.restaurant.repositories")
@EnableSwagger
@EnableWebMvc
public class WebMvcConfiguration extends WebMvcConfigurerAdapter{
	...
	public void addResourceHandlers(ResourceHandlerRegistry registry) {
		...
		registry.addResourceHandler("/resources/upload/ads/**").addResourceLocations("file:/opt/project/NhamEy/upload/ads/");	
