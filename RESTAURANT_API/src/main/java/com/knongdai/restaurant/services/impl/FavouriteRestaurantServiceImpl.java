...
import com.knongdai.restaurant.repositories.FavouriteRestaurantRepository;
import com.knongdai.restaurant.services.FavouriteRestaurantService;
...
public class FavouriteRestaurantServiceImpl implements FavouriteRestaurantService {
	...
	public int countFavoriteRest() {
		return favouriteRestaurantRepository.countFavoriteRest();
	}
